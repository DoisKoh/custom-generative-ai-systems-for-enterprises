<script lang="ts">
	...
	const suggestedActions = [
		{
			title: 'Food Nearby',
			label: 'Where can I eat nearby?',
			action: 'Where can I eat nearby?'
		},
		{
			title: 'Hawkers within 5km',
			label: 'Find Hawker centres within 5km',
			action: 'Find Hawker centres within 5km'
		},
		{
			title: 'Closest Hawker Center',
			label: 'Show me the closest Hawker centre',
			action: 'Show me the closest Hawker centre'
		},
		{
			title: 'Popular Hawker Centers',
			label: 'What are the popular Hawker centres nearby?',
			action: 'What are the popular Hawker centres nearby?'
		}
	];
</script>
